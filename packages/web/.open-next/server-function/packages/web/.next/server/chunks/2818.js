...
const _utils = __webpack_require__(66156);
const _error = __webpack_require__(59812);
...
const _uaparserjs = /*#__PURE__*/ _interop_require_default(__webpack_require__(7526));
...
const serverExports = {
    NextRequest: (__webpack_require__(18012).NextRequest),
    NextResponse: (__webpack_require__(23452).NextResponse),
    ImageResponse: (__webpack_require__(50144)/* .ImageResponse */ .E),
    userAgentFromString: (__webpack_require__(76802).userAgentFromString),
    userAgent: (__webpack_require__(76802).userAgent)
};
